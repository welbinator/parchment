...
import { Plus, X, File, FileText, Map, CheckSquare } from 'lucide-react';
...
export default function KanbanView() {
  const { activePageId, setActivePage, addPage } = useAppStore();
  ...
  const handleAddPage = async (collectionId: string, type: PageType = 'blank') => {
    ...
    // The new page will be set as active by addPage — open it
    setModalOpen(true);
  };
